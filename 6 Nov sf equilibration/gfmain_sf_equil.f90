...
real(8) :: corr_equilibration(1:nn,1:nn), sf_equil_pipi, sf_equil_pizero
...
real(8) :: cosk1,sink1,cosk2,sink2
...
sf_equil_pipi = sf_equil_pipi/dble(nn)
sf_equil_pizero = sf_equil_pizero/dble(nn)
...
subroutine sf_corr_equil_zero
use hyzer; implicit none

corr_equilibration(:,:) = 0.d0
sf_equil_pipi = 0.d0
sf_equil_pizero = 0.d0
end subroutine sf_corr_equil_zero
