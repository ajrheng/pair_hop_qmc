...
!    write(12,*)'Starting equilibration with N<0.5 parameters.'
!    write(12,*)'mu=',mu
!    close(12)
!    lopers=0.d0
!    nloops=0.d0
...
!        if (mod(i,istep/20).eq.0) call adjnl
        !call write_sf_equilibration(i)
        !call write_stiffness_equilibration(i)
        !if (i<=500) then
        !    call writeconf
        !endif
!    enddo
!    open(12,file='log.txt',status='unknown',access='append')
!    write(12,*)'Completed 1st equilibration: L = ',l
!    close(12)
!endif
...
if (istep.ne.0) then
    open(12,file='log.txt',status='unknown',access='append')
    write(12,*)'Starting equilibration with normal parameters.'
    write(12,*)'mu=',mu
    close(12)
    lopers=0.d0
    nloops=0.d0
    ...
    enddo
    open(12,file='log.txt',status='unknown',access='append')
    write(12,*)'Completed 2nd equilibration: L = ',l
    close(12)
endif
